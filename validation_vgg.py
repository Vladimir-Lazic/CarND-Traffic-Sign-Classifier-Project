...
with tf.Session() as sess:
    ...
    model_prediction, prediction_index = predict_single_label(x_image=empty_image)
    print('Network Input: ', image_labels[label])
    print('Network Prediction: ', model_prediction)
    print('Prediction correct' if label == prediction_index else 'Prediction incorrect')
