...
def VGG(x):
    ...
    conv1_W = tf.Variable(
        tf.truncated_normal(shape=(3, 3, 1, 32), mean=mu, stddev=sigma), name="conv1_W"
    )
    ...
    conv2_W = tf.Variable(
        tf.truncated_normal(shape=(3, 3, 32, 32), mean=mu, stddev=sigma), name="conv2_W"
    )
    ...
    conv3_W = tf.Variable(
        tf.truncated_normal(shape=(3, 3, 32, 64), mean=mu, stddev=sigma), name="conv3_W"
    )
    ...
    conv4_W = tf.Variable(
        tf.truncated_normal(shape=(3, 3, 64, 64), mean=mu, stddev=sigma), name="conv4_W"
    )
    ...
    conv6 = tf.nn.max_pool(
        conv6, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID"
    )
    ...
    fc1_W = tf.Variable(
        tf.truncated_normal(shape=(2048, 128), mean=mu, stddev=sigma), name="fc1_W"
    )
    ...
    fc2_W = tf.Variable(
        tf.truncated_normal(shape=(128, 128), mean=mu, stddev=sigma), name="fc2_W"
    )
    ...
    fc3_W = tf.Variable(
        tf.truncated_normal(shape=(128, 43), mean=mu, stddev=sigma), name="fc3_W"
    )
