...
def VGGNet(x):
    ...
    conv1_W = tf.Variable(tf.truncated_normal(shape=(3, 3, 3, 32), mean=mu, stddev=sigma), name='conv1_W')
    ...
    conv2_W = tf.Variable(tf.truncated_normal(shape=(3, 3, 32, 32), mean=mu, stddev=sigma), name='conv2_W')
    ...
    fc1_W = tf.Variable(tf.truncated_normal(shape=(2048, 128), mean=mu, stddev=sigma), name='fc1_W')
    ...
    fc2_W = tf.Variable(tf.truncated_normal(shape=(128, 128), mean=mu, stddev=sigma), name='fc2_W')
    ...
    fc3_W = tf.Variable(tf.truncated_normal(shape=(128, 42), mean=mu, stddev=sigma), name='fc3_W')
